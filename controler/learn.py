...
if __name__ == '__main__':
    ...
    #
    # # call the class
    # bh = BehaviorClonning(env, ControllerDoublePendulum, 1000, folder_name="data2/")
    #
    # generate_data, train = False, True
    # if generate_data:
    #     # generate data.
    #     bh.generate_data()
    #
    ...
    if train:
        ...
        # train ilqr network
        bh3.model_train_ff(X_data_ilqr, Y_data_ilqr, "model_ilqr_pend3.h5")
